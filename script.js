const myWorks = [
    ...
    tech: "HTML5 / CSS3 / JavaScript[ES6+](Math.random / DOM)",
    link:"https://indexcode70.github.io/my-portfolio/myproject_5_omikuji/"
    },
    ...
    tech: "HTML5 / CSS3 / JavaScript[ES6+](Fetch API / async-await)",
    link: "https://indexcode70.github.io/my-portfolio/myproject_6_tenki/"
    },
    ...
    tech: "HTML5 / CSS3(calc) / JavaScript[ES6+](LocalStorage / JSON)",
    link: "https://indexcode70.github.io/my-portfolio/myproject_7_kaimono/"   
    },
...
function displayWorks() {
    ...
    myWorks.forEach(work => {
        ...
        card.innerHTML = `
        <h3>${work.title}</h3>
        <p class="tech-stack">Tech-Stack: ${work.tech}</p>
